...
import (
	...
	"github.com/khulnasoft-lab/goctl/v2/internal/keyring"
	ghAuth "github.com/khulnasoft-lab/go-goctl/v2/pkg/auth"
	ghConfig "github.com/khulnasoft-lab/go-goctl/v2/pkg/config"
)
...
func (c *AuthConfig) HasEnvToken() bool {
	...
	// Discussed here, but maybe worth revisiting: https://github.com/khulnasoft-lab/goctl/pull/7169#discussion_r1136979033
...
git_protocol: https
# What editor goctl should run when creating issues, pull requests, etc. If blank, will refer to environment.
editor:
# When to interactively prompt. This is a global config that cannot be overridden by hostname. Supported values: enabled, disabled
prompt: enabled
# A pager program to send command output to, e.g. "less". Set the value to "cat" to disable the pager.
pager:
# Aliases allow you to create nicknames for goctl commands
aliases:
  co: pr checkout
# The path to a unix socket througoctl which send HTTP connections. If blank, HTTP traffic will be handled by net/http.DefaultTransport.
http_unix_socket:
# What web browser goctl should use when opening URLs. If blank, will refer to environment.
browser:
`
...
func ConfigOptions() []ConfigOption {
	return []ConfigOption{
		...
		},
		{
			...
			Description:  "the path to a Unix socket througoctl which to make an HTTP connection",
			DefaultValue: "",
		},
		{
			Key:          browserKey,
