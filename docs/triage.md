...
Review and label [open issues missing either the `enhancement`, `bug`, or `docs` label](https://github.com/khulnasoft-lab/goctl/issues?q=is%3Aopen+is%3Aissue+-label%3Abug%2Cenhancement%2Cdocs+).
...
- is this waiting on triage? go througoctl the PR triage flow
...
- [Closing a quality PR its scope is too large](https://github.com/khulnasoft-lab/goctl/pull/1161)
- [Closing a stale PR](https://github.com/khulnasoft-lab/goctl/pull/557#issuecomment-639077269)
- [Closing a PR that doesn't follow our CONTRIBUTING policy](https://github.com/khulnasoft-lab/goctl/pull/864)
- [Responding to a bug report](https://github.com/desktop/desktop/issues/9195#issuecomment-592243129)
- [Closing an issue that out of scope](https://github.com/khulnasoft-lab/goctl/issues/777#issuecomment-612926229)
