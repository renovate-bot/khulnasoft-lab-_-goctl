...
import (
	...
	fd "github.com/khulnasoft-lab/goctl/v2/internal/featuredetection"
			...
			checkContexts: []api.CheckContext{
				{
					...
					DetailsURL:  "https://github.com/khulnasoft-lab/goctl/runs/1",
				},
				{
					TypeName:    "CheckRun",
					Name:        "lint",
					...
					StartedAt:   time.Date(2022, 1, 1, 1, 1, 1, 1, time.UTC),
					CompletedAt: time.Date(2022, 1, 1, 1, 1, 1, 1, time.UTC),
					DetailsURL:  "https://github.com/khulnasoft-lab/goctl/runs/2",
				},
				{
					TypeName:    "CheckRun",
					Name:        "lint",
					...
					DetailsURL:  "https://github.com/khulnasoft-lab/goctl/runs/3",
				},
			},
			want: []api.CheckContext{
				{
			...
			checkContexts: []api.CheckContext{
				{
					...
					CompletedAt: time.Date(2022, 1, 1, 1, 1, 1, 1, time.UTC),
					DetailsURL:  "",
					TargetURL:   "https://github.com/khulnasoft-lab/goctl/2",
				},
				{
					TypeName:    "StatusContext",
					Name:        "",
					...
					CompletedAt: time.Date(2022, 2, 2, 2, 2, 2, 2, time.UTC),
					DetailsURL:  "",
					TargetURL:   "https://github.com/khulnasoft-lab/goctl/3",
				},
				{
					TypeName:    "StatusContext",
					Name:        "",
					...
					CompletedAt: time.Date(2022, 1, 1, 1, 1, 1, 1, time.UTC),
					DetailsURL:  "",
					TargetURL:   "https://github.com/khulnasoft-lab/goctl/1",
				},
			},
			want: []api.CheckContext{
				{
