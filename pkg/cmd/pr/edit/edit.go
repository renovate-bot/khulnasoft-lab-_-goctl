...
import (
	...
	shared "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/pr/shared"
...
func NewCmdEdit(f *cmdutil.Factory, runF func(*EditOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		`),
		Example: heredoc.Doc(`
			$ goctl pr edit 23 --title "I found a bug" --body "Nothing works"
			$ goctl pr edit 23 --add-label "bug,help wanted" --remove-label "core"
			$ goctl pr edit 23 --add-reviewer monalisa,hubot  --remove-reviewer myorg/team-name
			$ goctl pr edit 23 --add-assignee "@me" --remove-assignee monalisa,hubot
			$ goctl pr edit 23 --add-project "Roadmap" --remove-project v1,v2
			$ goctl pr edit 23 --milestone "Version 1"
		`),
