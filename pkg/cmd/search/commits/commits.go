...
import (
	...
	"github.com/khulnasoft-lab/goctl/v2/pkg/cmd/search/shared"
...
func NewCmdCommits(f *cmdutil.Factory, runF func(*CommitsOptions) error) *cobra.Command {
    ...
    `),
		Example: heredoc.Doc(`
			...
			$ goctl search commits readme typo

			# search commits matching phrase "bug fix"
			$ goctl search commits "bug fix"

			# search commits committed by user "monalisa"
			$ goctl search commits --committer=monalisa

			# search commits authored by users with name "Jane Doe"
			$ goctl search commits --author-name="Jane Doe"

			# search commits matching hash "8dd03144ffdc6c0d486d6b705f9c7fba871ee7c3"
			$ goctl search commits --hash=8dd03144ffdc6c0d486d6b705f9c7fba871ee7c3

			# search commits authored before February 1st, 2022
			$ goctl search commits --author-date="<2022-02-01"
    `),
