...
func TestCodeRun(t *testing.T) {
	var query = search.Query{
		...
		Qualifiers: search.Qualifiers{
			Language: "go",
			Repo:     []string{"khulnasoft-lab/goctl"},
		},
	}
	tests := []struct {
		errMsg     string
	...
	}{
		{
			...
			tty:        true,
			wantStdout: "\nShowing 2 of 2 results\n\nkhulnasoft-lab/goctl context/context.go\n\trepoMap := map[string]bool{}\n\nkhulnasoft-lab/goctl pkg/cmd/pr/pr.go\n\tAnnotations: map[string]string{\n",
		},
		{
			...
			tty:        false,
			wantStdout: "khulnasoft-lab/goctl:context/context.go: repoMap := map[string]bool{}\nkhulnasoft-lab/goctl:pkg/cmd/pr/pr.go: Annotations: map[string]string{\n",
		},
		{
