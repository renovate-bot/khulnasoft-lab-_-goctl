...
func TestCloneRun(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantStdout: "✓ Cloned 2 labels from khulnasoft-lab/goctl to OWNER/REPO\n",
		},
		{
			...
			wantStdout: "✓ Cloned 1 label from khulnasoft-lab/goctl to OWNER/REPO\n",
		},
		{
			name: "has no labels",
			tty:  true,
			...
			wantStdout: "✓ Cloned 0 labels from khulnasoft-lab/goctl to OWNER/REPO\n",
		},
		{
			...
			wantStdout: "! Cloned 1 label of 2 from khulnasoft-lab/goctl to OWNER/REPO\n",
		},
		{
			...
			wantStdout: "! Cloned 0 labels of 2 from khulnasoft-lab/goctl to OWNER/REPO\n",
		},
		{
