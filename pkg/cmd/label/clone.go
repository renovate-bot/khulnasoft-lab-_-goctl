...
func newCmdClone(f *cmdutil.Factory, runF func(*cloneOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		`),
		Example: heredoc.Doc(`
			# clone and overwrite labels from khulnasoft-lab/goctl repository into the current repository
			$ goctl label clone khulnasoft-lab/goctl --force

			# clone labels from khulnasoft-lab/goctl repository into a octocat/cli repository
			$ goctl label clone khulnasoft-lab/goctl --repo octocat/cli
		`),
