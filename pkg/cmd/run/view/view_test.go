...
import (
	...
	workflowShared "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/workflow/shared"
...
func TestViewRun(t *testing.T) {
	tests := []struct {
		...
		"repository": {
			...
			wantOut: "\n✓ trunk CI #2898 · 3\nTriggered via push about 59 minutes ago\n\nJOBS\n✓ cool job in 4m34s (ID 10)\n\nFor more information about the job, try: goctl run view --job=10\nView this run on GitHub: https://github.com/runs/3\n",
		},
		{
		...
		},
		{
			...
			wantOut: heredoc.Doc(`
				...
				For more information about a job, try: goctl run view --job=<job-id>
				View this run on GitHub: https://github.com/runs/3
			`),
		},
		{
		...
		},
		{
			...
			wantOut: "\n✓ trunk CI · 3\nTriggered via push about 59 minutes ago\n\n✓ cool job in 4m34s (ID 10)\n  ✓ fob the barz\n  ✓ barz the fob\n\nTo see the full job log, try: goctl run view --log --job=10\nView this run on GitHub: https://github.com/runs/3\n",
		},
		{
