...
func NewCmdCreate(f *cmdutil.Factory, runF func(*CreateOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: heredoc.Docf(`
			...
			To create a repository interactively, use %[1]sgoctl repo create%[1]s with no arguments.
		...
		Example: heredoc.Doc(`
			...
			goctl repo create my-project --public --clone

			# create a remote repository from the current directory
			goctl repo create my-project --private --source=. --remote=upstream
		`),
