...
func TestNewCmdStatus(t *testing.T) {
	tests := []struct {
		...
		{
			name: "exclude",
			cli:  "-e khulnasoft-lab/goctl,khulnasoft-lab/go-goctl",
			wants: StatusOptions{
				Exclude: []string{"khulnasoft-lab/goctl", "khulnasoft-lab/go-goctl"},
			},
		},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				...
				reg.Register(
					httpmock.REST("GET", "repos/khulnasoft-lab/goctl/issues/1096"),
				...
				reg.Register(
					httpmock.REST("GET", "repos/vilmibm/goctl-screensaver/issues/comments/10"),
			...
			opts:    &StatusOptions{},
			wantOut: "Assigned Issues                       │ Assigned Pull Requests                \nvilmibm/testing#157     yolo          │ khulnasoft-lab/goctl#5272  Pin extensions          \nkhulnasoft-lab/goctl#3223            Repo garden...│ rpd/todo#73   Board up RPD windows    \nrpd/todo#514            Reducing zo...│ khulnasoft-lab/goctl#4768  Issue Frecency          \nvilmibm/testing#74      welp          │                                       \nadreyer/arkestrator#22  complete mo...│                                       \n                                      │                                       \nReview Requests                       │ Mentions                              \nkhulnasoft-lab/goctl#5272          Pin extensions  │ rpd/todo#110               hello @j...\nvilmibm/testing#1234  Foobar          │ khulnasoft-lab/goctl#1096               @jillval...\nrpd/todo#50           Welcome party...│ vilmibm/goctl-screensaver#15  a messag...\nkhulnasoft-lab/goctl#4671          This pull req...│                                       \nrpd/todo#49           Haircut for Leon│                                       \n                                      │                                       \nRepository Activity\nrpd/todo#5326         new PR                        Only write UTF-8 BOM on W...\nvilmibm/testing#5325  comment on Ability to sea...  We are working on dedicat...\nkhulnasoft-lab/goctl#5319          comment on [Codespaces] D...  Wondering if we shouldn't...\nkhulnasoft-lab/goctl#5300          new issue                     Terminal bell when a runn...\n\n",
		},
		{
			...
			opts: &StatusOptions{
				Exclude: []string{"khulnasoft-lab/goctl"},
			},
			// NOTA BENE: you'll see khulnasoft-lab/goctl in search results because that happens
			// server side and the fixture doesn't account for that
			wantOut: "Assigned Issues                       │ Assigned Pull Requests                \nvilmibm/testing#157     yolo          │ khulnasoft-lab/goctl#5272  Pin extensions          \nkhulnasoft-lab/goctl#3223            Repo garden...│ rpd/todo#73   Board up RPD windows    \nrpd/todo#514            Reducing zo...│ khulnasoft-lab/goctl#4768  Issue Frecency          \nvilmibm/testing#74      welp          │                                       \nadreyer/arkestrator#22  complete mo...│                                       \n                                      │                                       \nReview Requests                       │ Mentions                              \nkhulnasoft-lab/goctl#5272          Pin extensions  │ rpd/todo#110               hello @j...\nvilmibm/testing#1234  Foobar          │ vilmibm/goctl-screensaver#15  a messag...\nrpd/todo#50           Welcome party...│                                       \nkhulnasoft-lab/goctl#4671          This pull req...│                                       \nrpd/todo#49           Haircut for Leon│                                       \n                                      │                                       \nRepository Activity\nrpd/todo#5326         new PR                        Only write UTF-8 BOM on W...\nvilmibm/testing#5325  comment on Ability to sea...  We are working on dedicat...\n\n",
		},
		{
			...
			opts: &StatusOptions{
				Exclude: []string{"khulnasoft-lab/goctl", "rpd/todo"},
			},
			// NOTA BENE: you'll see khulnasoft-lab/goctl in search results because that happens
			// server side and the fixture doesn't account for that
			wantOut: "Assigned Issues                       │ Assigned Pull Requests                \nvilmibm/testing#157     yolo          │ khulnasoft-lab/goctl#5272  Pin extensions          \nkhulnasoft-lab/goctl#3223            Repo garden...│ rpd/todo#73   Board up RPD windows    \nrpd/todo#514            Reducing zo...│ khulnasoft-lab/goctl#4768  Issue Frecency          \nvilmibm/testing#74      welp          │                                       \nadreyer/arkestrator#22  complete mo...│                                       \n                                      │                                       \nReview Requests                       │ Mentions                              \nkhulnasoft-lab/goctl#5272          Pin extensions  │ vilmibm/goctl-screensaver#15  a messag...\nvilmibm/testing#1234  Foobar          │                                       \nrpd/todo#50           Welcome party...│                                       \nkhulnasoft-lab/goctl#4671          This pull req...│                                       \nrpd/todo#49           Haircut for Leon│                                       \n                                      │                                       \nRepository Activity\nvilmibm/testing#5325  comment on Ability to sea...  We are working on dedicat...\n\n",
		},
		{
			...
			wantOut: "Assigned Issues                       │ Assigned Pull Requests                \nvilmibm/testing#157     yolo          │ khulnasoft-lab/goctl#5272  Pin extensions          \nkhulnasoft-lab/goctl#3223            Repo garden...│ rpd/todo#73   Board up RPD windows    \nrpd/todo#514            Reducing zo...│ khulnasoft-lab/goctl#4768  Issue Frecency          \nvilmibm/testing#74      welp          │                                       \nadreyer/arkestrator#22  complete mo...│                                       \n                                      │                                       \nReview Requests                       │ Mentions                              \nkhulnasoft-lab/goctl#5272          Pin extensions  │ rpd/todo#110  hello @jillvalentine ...\nvilmibm/testing#1234  Foobar          │                                       \nrpd/todo#50           Welcome party...│                                       \nkhulnasoft-lab/goctl#4671          This pull req...│                                       \nrpd/todo#49           Haircut for Leon│                                       \n                                      │                                       \nRepository Activity\nrpd/todo#5326  new PR  Only write UTF-8 BOM on Windows where it is needed\n\n",
		},
		{
			...
			wantOut: heredoc.Doc(`
				...
				vilmibm/testing#157  yolo             │ khulnasoft-lab/goctl#5272  Pin extensions          
				                                      │                                       
				Review Requests                       │ Mentions                              
				khulnasoft-lab/goctl#5272  Pin extensions          │ khulnasoft-lab/goctl#1096               @jillval...
				                                      │ vilmibm/goctl-screensaver#15  a messag...
