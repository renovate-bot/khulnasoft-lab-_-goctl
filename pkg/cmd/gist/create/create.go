...
import (
	...
	"github.com/khulnasoft-lab/goctl/v2/pkg/cmd/gist/shared"
...
func NewCmdCreate(f *cmdutil.Factory, runF func(*CreateOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			...
			$ goctl gist create --public hello.py

			# create a gist with a description
			$ goctl gist create hello.py -d "my Hello-World program in Python"

			# create a gist containing several files
			$ goctl gist create hello.py world.py cool.txt

			# read from standard input to create a gist
			$ goctl gist create -

			# create a gist from output piped from another command
			$ cat cool.txt | goctl gist create
		`),
