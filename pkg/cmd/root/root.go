...
import (
	...
	actionsCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/actions"
	aliasCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/alias"
	"github.com/khulnasoft-lab/goctl/v2/pkg/cmd/alias/shared"
	apiCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/api"
	authCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/auth"
	browseCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/browse"
	cacheCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/cache"
	codespaceCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/codespace"
	completionCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/completion"
	configCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/config"
	extensionCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/extension"
	"github.com/khulnasoft-lab/goctl/v2/pkg/cmd/factory"
	gistCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/gist"
	gpgKeyCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/gpg-key"
	issueCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/issue"
	labelCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/label"
	orgCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/org"
	prCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/pr"
	projectCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/project"
	releaseCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/release"
	repoCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/repo"
	creditsCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/repo/credits"
	rulesetCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/ruleset"
	runCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/run"
	searchCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/search"
	secretCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/secret"
	sshKeyCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/ssh-key"
	statusCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/status"
	variableCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/variable"
	versionCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/version"
	workflowCmd "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/workflow"
...
func NewCmdRoot(f *cmdutil.Factory, version, buildDate string) (*cobra.Command, error) {
	...
	cmd := &cobra.Command{
		Use:   "goctl <command> <subcommand> [flags]",
		Short: "GitHub CLI",
		Long:  `Work seamlessly with GitHub from the command line.`,
		Example: heredoc.Doc(`
			$ goctl issue create
			$ goctl repo clone khulnasoft-lab/goctl
			$ goctl pr checkout 321
		`),
		...
		PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmdutil.IsAuthCheckEnabled(cmd) && !cmdutil.CheckAuth(cfg) {
				...
				if parent != nil && parent.Use == "codespace" {
					fmt.Fprintln(io.ErrOut, "To get started with GitHub CLI, please run:  goctl auth login -s codespace")
				} else {
	...
	if os.Getenv("GOCTL_COBRA") == "" {
		cmd.SilenceErrors = true
		cmd.SilenceUsage = true

		// this --version flag is checked in rootHelpFunc
		cmd.Flags().Bool("version", false, "Show goctl version")
