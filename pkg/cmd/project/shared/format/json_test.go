...
func TestJSONProjectDetailedItems(t *testing.T) {
			...
			Content: queries.ProjectItemContent{
				...
				Issue: queries.Issue{
					...
					Repository: struct {
						...
						NameWithOwner: "khulnasoft-lab/go-goctl",
					},
				},
			},
		},
	...
	assert.Equal(
		t,
		`{"items":[{"content":{"type":"Issue","body":"a body","title":"Issue title","number":1,"repository":"khulnasoft-lab/go-goctl","url":"issue-url"},"id":"issueId"},{"content":{"type":"PullRequest","body":"a body","title":"Pull Request title","number":2,"repository":"khulnasoft-lab/go-goctl","url":"pr-url"},"id":"pullRequestId"},{"content":{"type":"DraftIssue","body":"a body","title":"Pull Request title"},"id":"draftIssueId"}],"totalCount":5}`,
		string(out))
}
