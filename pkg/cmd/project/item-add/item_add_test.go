...
func TestNewCmdaddItem(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "not-a-number",
			cli:         "x --url github.com/khulnasoft-lab/goctl",
			wantsErr:    true,
			wantsErrMsg: "invalid number: x",
		},
		{
			name: "url",
			cli:  "--url github.com/khulnasoft-lab/goctl",
			wants: addItemOpts{
				itemURL: "github.com/khulnasoft-lab/goctl",
			},
		},
		{
			name: "number",
			cli:  "123 --url github.com/khulnasoft-lab/goctl",
			wants: addItemOpts{
				number:  123,
				itemURL: "github.com/khulnasoft-lab/goctl",
			},
		...
		{
			name: "owner",
			cli:  "--owner monalisa --url github.com/khulnasoft-lab/goctl",
			wants: addItemOpts{
				owner:   "monalisa",
				itemURL: "github.com/khulnasoft-lab/goctl",
			},
		...
		{
			name: "json",
			cli:  "--format json --url github.com/khulnasoft-lab/goctl",
			wants: addItemOpts{
				format:  "json",
				itemURL: "github.com/khulnasoft-lab/goctl",
			},
	...
	t.Setenv("GOCTL_TOKEN", "auth-token")
...
func TestRunAddItem_User(t *testing.T) {
	...
	gock.New("https://api.github.com").
		...
		JSON(map[string]interface{}{
			...
			"variables": map[string]interface{}{
				"url": "https://github.com/khulnasoft-lab/go-goctl/issues/1",
			},
		}).
		Reply(200).
		JSON(map[string]interface{}{
	...
	config := addItemConfig{
		opts: addItemOpts{
			owner:   "monalisa",
			number:  1,
			itemURL: "https://github.com/khulnasoft-lab/go-goctl/issues/1",
		},
		client: client,
		io:     ios,
	}
...
func TestRunAddItem_Me(t *testing.T) {
	...
	gock.New("https://api.github.com").
		...
		JSON(map[string]interface{}{
			"query": "query GetIssueOrPullRequest.*",
			"variables": map[string]interface{}{
				"url": "https://github.com/khulnasoft-lab/go-goctl/pull/1",
			},
		}).
		Reply(200).
		JSON(map[string]interface{}{
	...
	config := addItemConfig{
		opts: addItemOpts{
			owner:   "@me",
			number:  1,
			itemURL: "https://github.com/khulnasoft-lab/go-goctl/pull/1",
		},
		client: client,
		io:     ios,
	}
