...
func NewCmdEditItem(f *cmdutil.Factory, runF func(config editItemConfig) error) *cobra.Command {
	...
	editItemCmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			...
			goctl project item-edit --id <item-ID> --field-id <field-ID> --project-id <project-ID> --text "new text"

			# clear an item's field value
			goctl project item-edit --id <item-ID> --field-id <field-ID> --project-id <project-ID> --clear
		`),
