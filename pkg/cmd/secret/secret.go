...
import (
	...
	cmdDelete "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/secret/delete"
	cmdList "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/secret/list"
	cmdSet "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/secret/set"
...
func NewCmdSecret(f *cmdutil.Factory) *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: heredoc.Doc(`
			...
			GitHub Actions. Run "goctl help secret set" to learn how to get started.
`),
	}
