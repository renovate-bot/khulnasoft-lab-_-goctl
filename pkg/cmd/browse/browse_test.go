...
func Test_runBrowse(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			baseRepo:    ghrepo.New("vilmibm", "goctl-user-status"),
			wantsErr:    false,
			expectedURL: "https://github.com/vilmibm/goctl-user-status/tree/6f1a2405cace1633d89a79c74c65f22fe78f9659",
		},
		{
			...
			baseRepo:    ghrepo.New("vilmibm", "goctl-user-status"),
			wantsErr:    false,
			expectedURL: "https://github.com/vilmibm/goctl-user-status/tree/6f1a2405cace1633d89a79c74c65f22fe78f9659/main.go",
		},
		{
		...
		},
		{
			...
			baseRepo:      ghrepo.New("bchadwic", "goctl-graph"),
			defaultBranch: "trunk",
			expectedURL:   "https://github.com/bchadwic/goctl-graph/tree/trunk/pkg/cmd/browse/browse_test.go",
			wantsErr:      false,
		},
		{
			...
			baseRepo:      ghrepo.New("bchadwic", "goctl-graph"),
			defaultBranch: "trunk",
			expectedURL:   "https://github.com/bchadwic/goctl-graph/tree/trunk/pkg/cmd/pr",
			wantsErr:      false,
		},
		{
			...
			baseRepo:      ghrepo.New("bchadwic", "goctl-graph"),
			defaultBranch: "trunk",
			expectedURL:   "https://github.com/bchadwic/goctl-graph/tree/trunk/README.md",
			wantsErr:      false,
		},
		{
