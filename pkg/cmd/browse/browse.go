...
func NewCmdBrowse(f *cmdutil.Factory, runF func(*BrowseOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			...
			$ goctl browse 77507cd94ccafcf568f8560cfecde965fcfa63
			#=> Open commit page

			$ goctl browse --settings
			#=> Open repository settings

			$ goctl browse main.go:312
			#=> Open main.go at line 312

			$ goctl browse main.go --branch bug-fix
			#=> Open main.go with the repository at head of bug-fix branch

			$ goctl browse main.go --commit=77507cd94ccafcf568f8560cfecde965fcfa63
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("repo") || os.Getenv("GOCTL_REPO") != "" {
