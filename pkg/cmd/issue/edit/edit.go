...
import (
	...
	shared "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/issue/shared"
	prShared "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/pr/shared"
...
func NewCmdEdit(f *cmdutil.Factory, runF func(*EditOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		`),
		Example: heredoc.Doc(`
			$ goctl issue edit 23 --title "I found a bug" --body "Nothing works"
			$ goctl issue edit 23 --add-label "bug,help wanted" --remove-label "core"
			$ goctl issue edit 23 --add-assignee "@me" --remove-assignee monalisa,hubot
			$ goctl issue edit 23 --add-project "Roadmap" --remove-project v1,v2
			$ goctl issue edit 23 --milestone "Version 1"
			$ goctl issue edit 23 --body-file body.txt
			$ goctl issue edit 23 34 --add-label "help wanted"
		`),
