...
func NewCmdCreate(f *cmdutil.Factory, runF func(*CreateOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		`),
		Example: heredoc.Doc(`
			$ goctl issue create --title "I found a bug" --body "Nothing works"
			$ goctl issue create --label "bug,help wanted"
			$ goctl issue create --label bug --label "help wanted"
			$ goctl issue create --assignee monalisa,hubot
			$ goctl issue create --assignee "@me"
			$ goctl issue create --project "Roadmap"
		`),
