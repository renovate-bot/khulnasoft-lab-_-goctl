...
import (
	...
	issueShared "github.com/khulnasoft-lab/goctl/v2/pkg/cmd/issue/shared"
...
func NewCmdList(f *cmdutil.Factory, runF func(*ListOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		`),
		Example: heredoc.Doc(`
			$ goctl issue list --label "bug" --label "help wanted"
			$ goctl issue list --author monalisa
			$ goctl issue list --assignee "@me"
			$ goctl issue list --milestone "The big 1.0"
			$ goctl issue list --search "error no:assignee sort:created-asc"
		`),
		Aliases: []string{"ls"},
