...
func Test_codespace_displayName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "khulnasoft-lab/goctl (trunk): scuba steve",
		},
		{
		...
		},
		{
			...
			want: "jimmy           khulnasoft-lab/goctl (trunk): scuba steve",
		},
	}
...
func Test_formatCodespacesForSelect(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantCodespacesNames: []string{
				"khulnasoft-lab/goctl (trunk): scuba steve",
			},
		},
		{
			...
			wantCodespacesNames: []string{
				"khulnasoft-lab/goctl (trunk): scuba steve",
				"khulnasoft-lab/goctl (trunk): flappy bird",
			},
		},
		{
			...
			wantCodespacesNames: []string{
				"khulnasoft-lab/goctl (trunk): scuba steve",
				"khulnasoft-lab/goctl (feature): flappy bird",
			},
		},
		{
