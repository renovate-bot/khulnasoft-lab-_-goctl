...
import (
	...
	"github.com/khulnasoft-lab/goctl/v2/pkg/cmd/extension"
...
func ioStreams(f *cmdutil.Factory) *iostreams.IOStreams {
	...
	if _, ghPromptDisabled := os.LookupEnv("GOCTL_PROMPT_DISABLED"); ghPromptDisabled {
	...
	// 2. pager from config
	// 3. PAGER
	if ghPager, ghPagerExists := os.LookupEnv("GOCTL_PAGER"); ghPagerExists {
		io.SetPager(ghPager)
