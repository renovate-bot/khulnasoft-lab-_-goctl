...
import (
	...
	"github.com/khulnasoft-lab/goctl/v2/pkg/cmd/release/shared"
	"github.com/khulnasoft-lab/goctl/v2/pkg/cmdutil"
	"github.com/khulnasoft-lab/goctl/v2/pkg/iostreams"
	"github.com/khulnasoft-lab/goctl/v2/pkg/surveyext"
...
func NewCmdCreate(f *cmdutil.Factory, runF func(*CreateOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			...
			$ goctl release create

			Interactively create a release from specific tag
			$ goctl release create v1.2.3

			Non-interactively create a release
			$ goctl release create v1.2.3 --notes "bugfix release"

			Use automatically generated release notes
			$ goctl release create v1.2.3 --generate-notes

			Use release notes from a file
			$ goctl release create v1.2.3 -F changelog.md

			Upload all tarballs in a directory as release assets
			$ goctl release create v1.2.3 ./dist/*.tgz

			Upload a release asset with a display label
			$ goctl release create v1.2.3 '/path/to/asset.zip#My display label'

			Create a release and start a discussion
			$ goctl release create v1.2.3 --discussion-category "General"
		`),
		Aliases: []string{"new"},
