...
func TestRepositoryExportData(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			output: `{"createdAt":"2021-02-28T12:30:00Z","description":"description","fullName":"khulnasoft-lab/goctl","isArchived":true,"isFork":false,"isPrivate":false,"pushedAt":"2021-02-28T12:30:00Z"}`,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
